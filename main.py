...
class ScreenFade():
    ...
    def fade(self):
        ...
        # bc the screen is wider than tall using the width ensures the fade works in both directions
...
world = World()
# runs process_data on world and pulls the player and health bar instance generated by it
...
while run:
    ...
    if start_game == False:
        ...
        screen.fill(BG)
        # draw buttons
        # if start is clicked start the game and the intro
        if start_button.draw(screen):
            start_game = True
            start_intro = True
        # if exit is clicked end the pygame session
    ...
    # if the game has started
        ...
        # show intro
        if start_intro == True:
            # run the screen fade and check that it completes
            if intro_fade.fade():
                start_intro = False
        ...
        # if the player is dead
            ...
            screen_scroll = 0
            # performs the fade and checks that it completes
            if death_fade.fade():
